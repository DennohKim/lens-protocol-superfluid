...
export default function Home() {
  ...
  return (
    <main className='flex flex-col justify-between p-24'>
      ...
      {currentAccount && <p className='mt-3 mb-3'>{currentAccount}</p>}
      ...
      <div className='mt-3 mb-3'>
        <button
          ...
          className={`${
            !topFollowers ? 'bg-green-400' : 'bg-gray-200'
          } py-2 px-10 text-black`}
        >
          All Followers
        </button>
        <button
          ...
          className={`${
            topFollowers ? 'bg-green-400' : 'bg-gray-200'
          } py-2 px-10 ml-1 text-black`}
        >
          Top Followers
        </button>
      </div>
      {viewType === 'base-followers' &&
